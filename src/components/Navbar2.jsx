...
export default function Navbar() {
  ...
  return (
    <header
      className="relative bg-gradient-to-r from-[#4d8acd] from-50% to-[#7462fc] text-white shadow-xl border-b border-white/20 overflow-visible z-[100] backdrop-blur-sm"
        ...
        <div className="max-w-full mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8 py-2 sm:py-3">
          ...
          <div className="flex-1 flex justify-center">
            <nav className="hidden lg:flex items-center space-x-1 font-medium text-sm text-white">
              <Link
                href="/"
                className="relative px-4 py-2 rounded-lg hover:text-white transition-all duration-300 group"
                aria-label="Home"
              >
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    size={14}
                    className={`transition-all duration-300 ${browseOpen ? 'rotate-180 text-white' : ''}`}
                  />
                  <div className="absolute inset-0 bg-white/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
                ...
                {browseOpen && (
                  <div className="absolute top-full left-0 pt-2 w-64 z-[999]" id="browse-dropdown">
                    <div className="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-xl shadow-xl overflow-visible">
                      <div className="py-3">
          ...
          <div className="md:hidden lg:hidden flex justify-end">
            ...
            >
              <div className="relative">
                {open ? (
                  <X size={26} className="drop-shadow-sm transition-transform duration-300 rotate-180" />
                ) : (
                  <Menu size={26} className="drop-shadow-sm transition-transform duration-300" />
                )}
            ...
            <div className="px-6 py-6 space-y-3">
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <ChevronDown
                    size={18}
                    className={`transition-transform duration-300 ${browseOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                {browseOpen && (
                  <div className="mt-2 ml-6 space-y-1 max-h-48 overflow-y-auto" id="mobile-browse-dropdown">
